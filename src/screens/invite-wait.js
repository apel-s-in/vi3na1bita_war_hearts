...
if (isLan && lanCode) {
const rankBadge =
  '<div style="display:inline-block;padding:5px 14px;border-radius:999px;background:rgba(255,152,0,.2);border:1px solid rgba(255,152,0,.4);color:#ffb74d;font-size:12px;font-weight:900;margin-bottom:12px">🏆 РЕЙТИНГОВЫЙ БОЙ · СТАВКА 100 ♦</div>';
el.innerHTML = `
<h2>📶 Игра по Wi-Fi</h2>
${rankBadge}
