...
const shardsEarned = isRanked && isNetwork && isWin ? 100 : (isRanked && isNetwork ? 10 : 0);
const rankBadge = isRanked
? (shardsEarned > 0
? `<div style="padding:6px 16px;border-radius:999px;background:rgba(76,175,80,.2);border:1px solid rgba(76,175,80,.4);color:#81c784;font-size:13px;font-weight:900;display:inline-block;margin-bottom:10px">🏆 +${shardsEarned} осколков</div>`
: `<div style="padding:6px 16px;border-radius:999px;background:rgba(255,152,0,.15);border:1px solid rgba(255,152,0,.3);color:#ffb74d;font-size:13px;font-weight:900;display:inline-block;margin-bottom:10px">🏆 Рейтинговый бой</div>`)
: (isNetwork
? '<div style="padding:6px 16px;border-radius:999px;background:rgba(124,77,255,.2);border:1px solid rgba(124,77,255,.4);color:#b388ff;font-size:13px;font-weight:900;display:inline-block;margin-bottom:10px">👤 Гостевой бой · без осколков</div>'
: '');
